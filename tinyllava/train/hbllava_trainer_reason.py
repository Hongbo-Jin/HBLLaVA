...
class HBTrainer_Reason(Trainer):
    def __init__(
        self,
    ...
    def compute_loss(self, model, inputs, num_items_in_batch=None):
        ...
        # print(f'prompt: {inputs[0]["prompt"]}')
