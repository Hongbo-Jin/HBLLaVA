...
from tinyllava.train.hbllava_trainer_reason import HBTrainer_Reason
...
def train():
    ...
    print(f'sample 1: {dataset["train"][0]}')
    ...
    print(f'prepocessors all initialized')
    
    trainer = HBTrainer_Reason(
        model=model,
